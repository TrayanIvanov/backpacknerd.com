    ...
    <div class="row">
        <div class="col-sm-7">
            <p>
                ...
                Backpack Nerd иска да помогне на тази кауза като дари <span class="error-color">100% от печалбата</span> на продадените календари на фондация "Дивите животни".<br />
                Цената на календар е <span class="error-color">9 лева</span>.<br />
                ...
                <span class="error-color">
                    С гордост обявявам кампанията за успешно прикючила!<br />
                    Тираж от 200 броя настолни календари се продаде за по-малко от 2 месеца.<br />
                    Събраните средства в помощ на фондацията са 1474 лева!<br /><br />
                </span>
