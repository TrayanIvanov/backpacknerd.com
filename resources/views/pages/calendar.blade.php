...
<div id="app" class="container page-articles">
    ...
    <div class="row">
        <div class="col-sm-7">
            <p>
                За трета поредна година Backpack Nerd пуска собствен календар с кауза!<br><br>
                ...
                Поради пандемичната обстановка тиражът тази година е намален на 150 бройки.<br>
                ...
                Заявените бройки ще бъдат изпращани чрез куриерските услуги на Еконт и Спиди за сметка на получателя.<br><br>
        ...
        <div class="col-sm-5">
            <a href="images/calendar/calendar_21.jpg" title="Backpack Nerd Calendar 2021" class="fancybox-images">
                <img src="images/calendar/calendar_21_thumb.jpg" title="Backpack Nerd" alt="Backpack Nerd" class="img-responsive project-thumb" />
            </a>
    ...
    <div class="row">
         <div class="col-sm-7">
            <p>
                С гордост обявявам кампанията за успешно приключила!<br>
                Тираж от 300 броя настолни календари се продаде за по-малко от 3 месеца.<br>
                Събраните средства в помощ на фондация "Дивите животни" са <span class="error-color">2150 лева</span>!
            </p>
...
@section('meta.title'){{ "Календар 2021 - " }}@endsection
@section('meta.desc'){{ "Купи си календар с кауза - " }}@endsection
@section('og.title'){{ "Календар с кауза 2021 - Backpack Nerd" }}@endsection
@section('og.desc'){{ "Купи си календар с кауза - помощ на фондация Дивите животни - Backpack Nerd" }}@endsection
@section('og.image'){{ url('images/calendar/calendar_21_thumb.jpg') }}@endsection
